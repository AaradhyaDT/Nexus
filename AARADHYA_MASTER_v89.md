# AARADHYA DEV TAMRAKAR — Master Profile v89

*Last updated: June 10, 2026 — v89: Nexus project added (AI Workflow Hub — personal AI operating system; repo `nexus` under AaradhyaDT; MIT license; React + FastAPI + PostgreSQL + ChromaDB; Day 1 skeleton built; session plan embedded as trigger context).*
...
| Jestha 29 | Jun 12 | Organization & Management |
...
- **Fusemachines AI Fellowship** (the primary focus): Weeks 1–6 complete[cite: 9]. This is the most valuable thing on the CV right now[cite: 9]. Every week's output needs to be real, understood code — not copy-pasted[cite: 9]. Fellowship ends mid-2026[cite: 9].
...
| 11 | Custom Processor FSM Design | 6.8 | Complete[cite: 9] |
| 12 | Fuse Fellowship Prep Toolkit | 6.5 | Complete[cite: 9] |
| 13 | Antenna Lab Data Analysis | 5.2 | Complete[cite: 9] |
